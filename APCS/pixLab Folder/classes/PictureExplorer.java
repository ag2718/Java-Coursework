...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
    ...
    public static void main(String args[]) {
        Picture originalGorge = new Picture("gorge.jpg");
        Picture largeGorge = originalGorge.scale(2, 2);
        largeGorge.write("largeGorge.jpg");
        Picture pix = new Picture("largeGorge.jpg");
        pix.explore();
    }
